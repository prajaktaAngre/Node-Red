    ...
    var registry = (function() {
        ...
        var exports = {
            ...
            registerNodeType: function(nt,def) {
                console.log("def in node.js 146",def)
                console.log("nt in node.js 146",nt)
                ...
                if (nt.substring(0,8) != "subflow:") {
                    ...
                    console.log("node.js 163",def.set)
                ...
                def.type = nt;
                console.log("node.js 186 def.type",def.type)
                nodeDefinitions[nt] = def;
                console.log("node.js 187 nodeDefinitions",nodeDefinitions[nt])
...
//   
    ...
    function addSubflow(sf, createNewIds) {
        ...
        linkTabMap[sf.id] = [];
        console.log("subflw 876 sf id",sf.id);
        console.log("subflw 876 sf",sf);
       ...
       console.log("node.js 915", sf._def)
       console.log("node.js 916", sf.instances)

        RED.events.emit("subflows:add",sf);
        console.log("node.js 923", sf)
    }
    ...
    function myFunctionReturn(){
      return myFunction(def)
       
    }
    function myFunction(def){
        def = registry.getNodeType(n.type);
        console.log("myfunction in nodes.js")
        console.log("myfunction in nodes.js d",def)
    }
    // return myFunction()
    /**
    ...
    function importNodes(newNodesObj,options) { // createNewIds,createMissingWorkspace) {
        ...
        newNodes = newNodes.filter(function(n) {
            ...
            seenIds[n.id] = true;
           console.log("get node 1640 node.js",id)
        ...
        console.log("node.js 1801",newNodes)
        for (i=0;i<newNodes.length;i++) {
            n = newNodes[i];
            console.log("node.js 1804",n)
            // TODO: remove workspace in next release+1
            ...
            // console.log("addSubflw 1860 node.js",addSubflow)
            console.log("addSubflw 1860 node.js n",n)
            // console.log("addSubflw 1860 node.js createNewIds",createNewIds)
        }
        ...
        for (i=0;i<new_nodes.length;i++) {
            ...
            addNode(node);
            console.log("node.js 2302",node)
            addNode( RED.nodes.registerType('gitlab', {
    ...
    return {
        ...
        init: function() {
            ...
            //     }
            // });
            console.log("node.js 2560",this.registerType)
        ...
        myFunctionReturn:myFunctionReturn,
