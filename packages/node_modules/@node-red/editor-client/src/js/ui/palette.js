...
//     RED.nodes.registerType("pp",prjkta);
//  }
//   
RED.palette = (function () {
    
    // category=[{
        //     originalCategory:'pppp',
        //     category: 'pp',
        //     color: '#f0f0f8',
    ...
    var sidebarControls;
    // for creating category name.eg :own 
    function createCategory(originalCategory, rootCategory, category, ns) {
       
        console.log("categry before",category)
        ...
        console.log("createCategory originl node",originalCategory)
        console.log("createCategory rootCategory node",rootCategory)
        console.log("createCategory category node",category)

    }
    // creating e.g jira node with label jira.
    function createCategoryContainer(originalCategory, category, labelId) {
        ...
        console.log("createCategoryContainer originlnode",originalCategory)
        console.log("createCategoryContainer  category",category)
        console.log("createCategoryContainer  labelId",labelId)
        //open and close toggle for own category with expanded cls.
    ...
    //it creates separte node like jira, jenkins
    ...
    function addNodeType(nt, def) {
        ...
        console.log("line 251",nodeCategory)
        ...
        if (exclusion.indexOf(nodeCategory) === -1) {
            ...
            createCategory(nodeCategory, rootCategory, category, (ownCategory.indexOf(rootCategory) !== -1) ? "node-red" : def.set.id);
    ...
    //   console.log("init method",category)
       ...
       //our code
        // let mydiv = document.createElement("h6");
        // mydiv.innerHTML = "Custom node";
        // document.getElementById("red-ui-palette").appendChild(mydiv)
        // $('<div class="red-ui-palette-content"></div>').appendTo("#red-ui-palette")
        // document.getElementsByClassName("red-ui-palette-node ui-draggable ui-draggable-handle").append(div) 
      
        // $('<div class="red-ui-palette-content "></div>').appendTo("#red-ui-palette-container")
        // $("h6").addClass("red-ui-palette-node ui-draggable ui-draggable-handle ")
        // $("#red-ui-palette-input,#red-ui-palette-output").hide()
        // $("red-ui-paletteh6" ).draggable();  
    //     $("#red-ui-main-container h6").draggable();  
        
    //     $("#red-ui-main-container h6").bind('click', function( event ){  
    //         var cursor = $( "#red-ui-main-container h6" ).draggable( "option", "cursor" );  
    //         var cursorAt = $( "#red-ui-main-container h6" ).draggable( "option", "cursorAt" );  
    //         alert("Cursor type - " + cursor + ", cursorAt - " + cursorAt);  
    //    });  
  
        // var $elem = $('red-ui-palette');
        // $(".myclass").append(
    ...
    // } 
        ...
        //        "icon": "gitlab.png",
        //        "set": {
        //            "id": "node-red-contrib-example-gitlab-case/gitlab",
        //            "name": "gitlab",
        //            "types": [
        //                "gitlab"
        //            ],
        ...
        //            "local": true,
        //            "user": false,
        //            "module": "node-red-contrib-example-gitlab-case",
        //            "version": "1.0.0",
        //            "added": true
        //        },
        //        "type": "gitlab"
        ...
        disablebtn.innerHTML = "disable jenkins";
        document.getElementById("red-ui-palette-container").appendChild(disablebtn)
        disablebtn.onclick = function(action) {
            $.ajax({
                url: 'nodes/node-red-contrib-example-jenkins-case',
                type: 'PUT',
                data: JSON.stringify({
                    enabled: false
                }),
        ...
        console.log("userCategories after",userCategories)
        var addedCategories = {};
        console.log("adedcategorys",addedCategories)
        ...
        ownCategory.forEach(function (category) {
...
// }
    return {
        ...
        // addNodeTypeCustom :addNodeTypeCustom
    };
    //our code
    ...
    function ourFunction() {
       ...
       console.log("array works",nodeCustom)
