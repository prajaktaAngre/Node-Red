...
var RED = (function() {
    ...
    function excludeCustomNodes() {
        var arr=['node-red-contrib-example-lower-case','node-red-contrib-example-jira-case'];
        console.log("result in array",arr)
      ...
      for(i = 0; i < arr.length; i++) { 
        $.ajax({
          ...
          console.log("done part in api",arr[i])
      ...
      function includeCustomNodes() {
          var arr=['node-red-contrib-example-lower-case','node-red-contrib-example-github-case',
          'node-red-contrib-example-jenkins-case','node-red-contrib-example-jira-case'];
